...
func (in *AmbassadorConfigSpec) DeepCopyInto(out *AmbassadorConfigSpec) {
	*out = *in
	...
	out.ClusterRequestTimeout = in.ClusterRequestTimeout
	out.ClusterIdleTimeout = in.ClusterIdleTimeout
	out.ClusterMaxConnectionLifetime = in.ClusterMaxConnectionLifetime
}
